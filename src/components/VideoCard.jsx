...
const VideoCard = ({displayData,setDeleteVideoFromVideoCard,insideCategory}) => {
  ...
  const deleteVideo =async(id)=>{
    try{
      ...
      setDeleteVideoFromVideoCard(result)
    }catch(err){
      console.log(err);
  ...
  return (
    ...
    <Modal size='lg' centered show={show} onHide={handleClose}>
        ...
        <Modal.Body>
        <iframe width="100%" height="560" src={`${displayData?.youTubeLink}?autoplay=1`} title="Caption"  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
